        ...
        await transporter.sendMail({
          ...
          html: `
            <div style="font-family: system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #1E293B;">
              ...
              <a href="${meet_link}" style="display: block; background: #1a73e8; color: #fff; text-align: center; padding: 12px 24px; border-radius: 6px; font-size: 14px; font-weight: 600; text-decoration: none; margin-bottom: 24px;">Join Google Meet</a>
              <p style="font-size: 13px; color: #94A3B8; margin: 24px 0 0; border-top: 1px solid #E2E8F0; padding-top: 16px;">
